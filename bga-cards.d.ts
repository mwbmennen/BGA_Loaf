...
// AnimationManager intentionally not redeclared here (bga-cards.d.ts ships its own loose
// `type AnimationManager = any;` placeholder for standalone use) -- removed because it collides
// with bga-animations.d.ts's real `declare class AnimationManager` when both files are present
// in the same project, which is always true here (docs/loaf-phase5-plan.md §4 step 1 imports
// both together). Confirmed via `npx tsc --noEmit`: TS2300 Duplicate identifier before this
// line was removed. Leave this file relying on bga-animations.d.ts's real declaration instead.
/**
