...
# On stop: if neither bga-studio-reference.md nor loaf-remarks.md was modified today,
...
echo '{"continue": false, "stopReason": "Before finishing: review this session for any new lessons learned. Generic BGA Studio/framework conventions go in docs/bga-studio-reference.md; L'\''Oaf-specific implementation judgment calls and known gaps go in docs/loaf-remarks.md. If you found anything worth documenting in either, update it. If nothing new to add, just confirm briefly."}'
